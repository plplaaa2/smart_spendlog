...
const FRANCHISE_PRESETS = [
  ...
  // 교통
  // =============================================
  { keyword: '카카오택시', category: '교통/주유' },
  { keyword: '카카오T', category: '교통/주유' },
  { keyword: 'KAKAOT', category: '교통/주유' },
  { keyword: '우버', category: '교통/주유' },
  { keyword: 'UBER', category: '교통/주유' },
  { keyword: '타다', category: '교통/주유' },
  { keyword: '코레일', category: '교통/주유' },
  { keyword: 'KORAIL', category: '교통/주유' },
  { keyword: 'KTX', category: '교통/주유' },
  { keyword: 'SRT', category: '교통/주유' },
  { keyword: '고속버스', category: '교통/주유' },
  { keyword: '시외버스', category: '교통/주유' },
  { keyword: '티머니', category: '교통/주유' },
  { keyword: 'T-MONEY', category: '교통/주유' },
  { keyword: '따릉이', category: '교통/주유' },
  { keyword: '쏘카', category: '교통/주유' },
  { keyword: '그린카', category: '교통/주유' },
  { keyword: '제주항공', category: '교통/주유' },
  { keyword: '진에어', category: '교통/주유' },
  { keyword: '티웨이', category: '교통/주유' },
  { keyword: '에어부산', category: '교통/주유' },
  { keyword: '이스타항공', category: '교통/주유' },
  { keyword: '대한항공', category: '교통/주유' },
  { keyword: '아시아나', category: '교통/주유' },
  { keyword: 'GS칼텍스', category: '교통/주유' },
  { keyword: 'SK에너지', category: '교통/주유' },
  { keyword: 'S-OIL', category: '교통/주유' },
  { keyword: '에쓰오일', category: '교통/주유' },
  ...
  { keyword: '웨이브', category: '구독' },
  { keyword: '시즌', category: '구독' },
  { keyword: '티빙', category: '구독' },
  { keyword: '디즈니플러스', category: '구독' },
  { keyword: 'DISNEY+', category: '구독' },
  { keyword: '유튜브프리미엄', category: '구독' },
  { keyword: 'YOUTUBE', category: '구독' },
  { keyword: '애플뮤직', category: '구독' },
  { keyword: '멜론', category: '구독' },
  { keyword: '지니뮤직', category: '구독' },
  { keyword: '스포티파이', category: '구독' },
  { keyword: 'SPOTIFY', category: '구독' },
