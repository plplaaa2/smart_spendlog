...
//   - 외식비       : 음식점, 패스트푸드, 치킨, 편의점 등 직접 구매 음식
...
const FRANCHISE_PRESETS = [
  ...
  // 외식비 - 패스트푸드/버거
  // =============================================
  { keyword: '맥도날드', category: '외식비' },
  { keyword: 'MCDONALD', category: '외식비' },
  { keyword: '버거킹', category: '외식비' },
  { keyword: 'BURGER KING', category: '외식비' },
  { keyword: 'BURGERKING', category: '외식비' },
  { keyword: '롯데리아', category: '외식비' },
  { keyword: 'KFC', category: '외식비' },
  { keyword: '맘스터치', category: '외식비' },
  { keyword: '노브랜드버거', category: '외식비' },
  { keyword: '써브웨이', category: '외식비' },
  { keyword: '서브웨이', category: '외식비' },
  { keyword: 'SUBWAY', category: '외식비' },
  { keyword: '쉐이크쉑', category: '외식비' },
  { keyword: 'SHAKE SHACK', category: '외식비' },
  { keyword: '파이브가이즈', category: '외식비' },
  { keyword: 'FIVE GUYS', category: '외식비' },

  // =============================================
  // 외식비 - 치킨/피자
  // =============================================
  { keyword: '피자헛', category: '외식비' },
  { keyword: 'PIZZA HUT', category: '외식비' },
  { keyword: '도미노', category: '외식비' },
  { keyword: 'DOMINO', category: '외식비' },
  { keyword: '파파존스', category: '외식비' },
  { keyword: 'PAPA JOHN', category: '외식비' },
  { keyword: '미스터피자', category: '외식비' },
  { keyword: 'BBQ', category: '외식비' },
  { keyword: 'BHC', category: '외식비' },
  { keyword: '교촌', category: '외식비' },
  { keyword: '굽네치킨', category: '외식비' },
  { keyword: '네네치킨', category: '외식비' },
  { keyword: '처갓집', category: '외식비' },
  { keyword: '60계치킨', category: '외식비' },
  { keyword: '페리카나', category: '외식비' },
  { keyword: '또래오래', category: '외식비' },
  { keyword: '호식이두마리치킨', category: '외식비' },

  // =============================================
  // 외식비 - 한식/분식/중식/일식
  // =============================================
  { keyword: '본죽', category: '외식비' },
  { keyword: '본도시락', category: '외식비' },
  { keyword: '원할머니', category: '외식비' },
  { keyword: '김가네', category: '외식비' },
  { keyword: '고봉민김밥', category: '외식비' },
  { keyword: '바르다김선생', category: '외식비' },
  { keyword: '한솥', category: '외식비' },
  { keyword: '이삭토스트', category: '외식비' },
  { keyword: '빕스', category: '외식비' },
  { keyword: 'VIPS', category: '외식비' },
  { keyword: '아웃백', category: '외식비' },
  { keyword: 'OUTBACK', category: '외식비' },
  { keyword: 'TGI', category: '외식비' },
  { keyword: '애슐리', category: '외식비' },
  { keyword: '청담순두부', category: '외식비' },
  { keyword: '신전떡볶이', category: '외식비' },
  { keyword: '죠스떡볶이', category: '외식비' },
  { keyword: '엽기떡볶이', category: '외식비' },
  { keyword: '국대떡볶이', category: '외식비' },

  // =============================================
  // 외식비 - 대명사 및 대표 메뉴 키워드
  // =============================================
  { keyword: '식당', category: '외식비' },
  { keyword: '칼국수', category: '외식비' },
  { keyword: '마라탕', category: '외식비' },
  { keyword: '감자탕', category: '외식비' },
  { keyword: '해장국', category: '외식비' },
  { keyword: '국밥', category: '외식비' },
  { keyword: '찌개', category: '외식비' },
  { keyword: '족발', category: '외식비' },
  { keyword: '보쌈', category: '외식비' },
  { keyword: '삼겹살', category: '외식비' },
  { keyword: '갈비', category: '외식비' },
  { keyword: '곱창', category: '외식비' },
  { keyword: '막창', category: '외식비' },
  { keyword: '닭갈비', category: '외식비' },
  { keyword: '떡볶이', category: '외식비' },
  { keyword: '돈까스', category: '외식비' },
  { keyword: '돈가스', category: '외식비' },
  { keyword: '파스타', category: '외식비' },
  { keyword: '초밥', category: '외식비' },
  { keyword: '스시', category: '외식비' },
  { keyword: '샤브샤브', category: '외식비' },
  { keyword: '마라샹궈', category: '외식비' },
  { keyword: '양꼬치', category: '외식비' },
  { keyword: '탕수육', category: '외식비' },
  { keyword: '짜장면', category: '외식비' },
  { keyword: '짬뽕', category: '외식비' },
  { keyword: '중국집', category: '외식비' },
  { keyword: '포차', category: '외식비' },
  { keyword: '술집', category: '외식비' },
  { keyword: '호프', category: '외식비' },
  { keyword: '치킨', category: '외식비' },
  { keyword: '피자', category: '외식비' },
  ...
  { keyword: 'OpenAI', category: '구독' },
  { keyword: 'OPENAI', category: '구독' },
  { keyword: 'ChatGPT', category: '구독' },
  { keyword: 'CHATGPT', category: '구독' },
  { keyword: 'Anthropic', category: '구독' },
  { keyword: 'ANTHROPIC', category: '구독' },
  { keyword: 'Claude', category: '구독' },
  { keyword: 'CLAUDE', category: '구독' },
  { keyword: 'Google One', category: '구독' },
  { keyword: 'GOOGLE ONE', category: '구독' },
  { keyword: '구글원', category: '구독' },
  { keyword: 'Google Cloud', category: '구독' },
  { keyword: 'GOOGLE CLOUD', category: '구독' },
  { keyword: 'Gemini', category: '구독' },
  { keyword: '제미나이', category: '구독' },
  { keyword: 'Midjourney', category: '구독' },
  { keyword: 'MIDJOURNEY', category: '구독' },
  { keyword: '미드저니', category: '구독' },
  { keyword: 'Perplexity', category: '구독' },
  { keyword: 'PERPLEXITY', category: '구독' },
  { keyword: '퍼플렉시티', category: '구독' },
  { keyword: 'AWS', category: '구독' },
  { keyword: 'AMAZON WEB SERVICES', category: '구독' },
  { keyword: 'Amazon Web Services', category: '구독' },
  { keyword: 'Azure', category: '구독' },
  { keyword: 'AZURE', category: '구독' },
  { keyword: 'Microsoft Azure', category: '구독' },
  { keyword: 'Cloudflare', category: '구독' },
  { keyword: 'CLOUDFLARE', category: '구독' },
  { keyword: 'Vercel', category: '구독' },
  { keyword: 'VERCEL', category: '구독' },
  { keyword: 'Netlify', category: '구독' },
  { keyword: 'NETLIFY', category: '구독' },
  { keyword: 'Supabase', category: '구독' },
  { keyword: 'SUPABASE', category: '구독' },
  { keyword: 'Firebase', category: '구독' },
  { keyword: 'FIREBASE', category: '구독' },
  { keyword: '네이버클라우드', category: '구독' },
  { keyword: '네이버 클라우드', category: '구독' },
  { keyword: 'NAVER CLOUD', category: '구독' },
  { keyword: 'iCloud', category: '구독' },
  { keyword: 'ICLOUD', category: '구독' },
  { keyword: '아이클라우드', category: '구독' },
  { keyword: 'OneDrive', category: '구독' },
  { keyword: 'ONEDRIVE', category: '구독' },
  { keyword: '원드라이브', category: '구독' },
  ...
  // 렌탈 - 렌탈/렌트 서비스 전문 브랜드
  // =============================================
  { keyword: '코웨이', category: '렌탈' },
  { keyword: 'COWAY', category: '렌탈' },
  { keyword: '쿠쿠홈시스', category: '렌탈' },
  { keyword: '쿠쿠렌탈', category: '렌탈' },
  { keyword: 'SK매직', category: '렌탈' },
  { keyword: 'SKMAGIC', category: '렌탈' },
  { keyword: '교원웰스', category: '렌탈' },
  { keyword: '웰스렌탈', category: '렌탈' },
  { keyword: '현대렌탈', category: '렌탈' },
  { keyword: '현대큐밍', category: '렌탈' },
  { keyword: '바디프랜드', category: '렌탈' },
  { keyword: 'BODYFRIEND', category: '렌탈' },
  { keyword: '세라젬', category: '렌탈' },
  { keyword: 'CERAGEM', category: '렌탈' },
  { keyword: '롯데렌터카', category: '렌탈' },
  { keyword: 'LOTTE RENT', category: '렌탈' },
  { keyword: 'SK렌터카', category: '렌탈' },
  { keyword: 'SK RENT', category: '렌탈' },
  { keyword: 'LG전자 케어솔루션', category: '렌탈' },
  { keyword: 'LG케어솔루션', category: '렌탈' },
